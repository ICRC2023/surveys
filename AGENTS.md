...
This file provides guidance to AI coding agents (Claude Code, Codex, etc.) when working with code in this repository. Tool-specific notes live in companion files such as `CLAUDE.md`.
